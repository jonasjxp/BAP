...
def run_grasp_vrp_md(inst, iterations=50, alpha=0.2, respect_K=False, use_2opt=True):
    ...
    for _ in range(iterations):
        ...
        while unvisited:
            ...
            # -------- MOD 2: proíbe rota vazia depot->sink --------
...
def solve_node_md(
    ...
    for iter_cg in range(1, max_cg_iter + 1):
        ...
        # -------- MOD 4: forced arcs por subset de arestas --------
        valid_idx = []
        ...
        # -------- MOD 1: frota <= K via slack NÃO penalizado --------
